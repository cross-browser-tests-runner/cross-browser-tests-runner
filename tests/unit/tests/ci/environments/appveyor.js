...
describe('Appveyor', function() {
  ...
  describe('session', function() {
    ...
    it('should return a string in expected format "APPVEYOR-{build_no}.{job_no}-{uuid}" if relevant env vars are set', function() {
  ...
  describe('commit', function() {
    ...
    it('should return commit sha1 string if relevant env variables are set', function() {
