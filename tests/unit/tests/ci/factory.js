...
describe('Factory', function() {
  ...
  describe('get', function() {
    ...
    it('should throw an error if no known CI env variables are set', function() {
    ...
    it('should return Travis if relevant env variables are set', function() {
      if(!process.env.TRAVIS_BUILD_ID && !process.env.CIRCLE_BUILD_URL && !process.env.APPVEYOR_JOB_ID) {
    ...
    it('should return Circle if relevant env variables are set', function() {
      if(!process.env.TRAVIS_BUILD_ID && !process.env.CIRCLE_BUILD_URL && !process.env.APPVEYOR_JOB_ID) {
    ...
    it('should return Appveyor if relevant env variables are set', function() {
      if(!process.env.TRAVIS_BUILD_ID && !process.env.CIRCLE_BUILD_URL && !process.env.APPVEYOR_JOB_ID) {
