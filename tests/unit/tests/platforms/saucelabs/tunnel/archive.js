...
var
  ...
  archive = require('./../../../../../../lib/platforms/saucelabs/tunnel/archive'),
...
describe('Archive', function() {
  ...
  describe('fetch', function() {
    ...
    it('should retry in case HTTP requests fail and eventually bail out once retries are exhausted', function() {
      var url = ArchiveVars.url.replace(/^.*saucelabs\.com/, '')
      nock('https://saucelabs.com').get(url).times(5).replyWithError('simulating request failure')
      archive = new Archive()
