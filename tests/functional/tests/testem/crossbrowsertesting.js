...
describe('CrossBrowserTesting', function() {
  ...
  it('should successfully complete testem ci mode Jasmine 1.x tests for few browsers', function() {
    ...
    .create('node', [
        ...
        '-f',
        path.resolve(process.cwd(), 'tests/functional/conf/testem/jasmine-1/crossbrowsertesting.json')
    ], {
    ...
    .then(() => {
      if(!out.match(/Safari 11.0 \- sum should return the sum of two numbers./)) {
        utils.log.warn('Safari 11.0 sum test failed')
      }
      if(!out.match(/Safari 11.0 \- mult should return the product of two numbers./)) {
        utils.log.warn('Safari 11.0 mult test failed')
      }
      ...
      if(!out.match(/Chrome 55.0 \- sum should return the sum of two numbers./)) {
        utils.log.warn('Chrome 55.0 sum test failed')
      }
      if(!out.match(/Chrome 55.0 \- mult should return the product of two numbers./)) {
        utils.log.warn('Chrome 55.0 mult test failed')
      }
